...
using TechniciansRepo.Data;
using TechniciansRepo.Models;

namespace TechniciansRepo.Controllers
{
    public class KnowledgeBaseController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.KnowledgeBase != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.KnowledgeBase'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.KnowledgeBase'  is null.");
            }
            var knowledgeBase = await _context.KnowledgeBase.FindAsync(id);
            if (knowledgeBase != null)
            {
